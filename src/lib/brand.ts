export const brand = {
  ...
  freeTesterPromo: {
    title: "مجاناً؟! أيوه مجاناً تماماً!",
    subtitle: "تيستر 5 مللي من أي عطر تحبه — هنركبه ليك وهو هدية مننا 🎁",
    steps: [
      "فولو للصفحة",
      "لايك لكل البوستات",
      "شير للمهتمين بالعطور من صحابك ومعارفك",
      "ابعتلي كلمة «تمام» مع أسماء العطور اللي عاوزها",
    ],
    whatsappMessage: "تمام ✨\nعايز تيستر 5 مل مجاني من العطور دي:\n",
  },
  muskOudPromo: {
